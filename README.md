...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jvrkimk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jvrkimk.containers.anotherwebservice.com/
...
```
git clone git@github.com:mobin-mazahery-school/container-jvrkimk.git
cd container-jvrkimk
```
...
```
docker attach container-jvrkimk
```
